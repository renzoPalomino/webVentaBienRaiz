...
public class Departamento {
    ...
    public Departamento(int idInmu, String titulo, String direccion, double area, String img, String descrip, double precio, int tipo, int estado, int numhab, int numbanio, int numgarage, int aniocost) {
        this.idInmu = idInmu;
        this.titulo = titulo;
