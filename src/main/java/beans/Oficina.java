...
public class Oficina {
    ...
    public Oficina(int idInmu, String titulo, String direccion, double area, String img, String descrip, double precio, int tipo, int estado, int numbanio, int numgarage, int aniocost) {
        this.idInmu = idInmu;
        this.titulo = titulo;
