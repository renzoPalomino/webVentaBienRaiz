...
<title>Actualizar Terreno</title>
</head>
<body>
    <%   
        Terreno ter=(Terreno)request.getAttribute("dato");
    %>
...
<h1>Actualizar Terreno</h1>
    <form action="control" id="id_form" method="post" enctype="multipart/form-data"> 
        <input name="coda" type="hidden" value="<%=ter.getIdInmu()%>">
        <input type="hidden" name="op" value="23">	
        <div class="form-group">
            <label class="control-label" for="id_titulo">Titulo</label>
            <input class="form-control" type="text" id="id_titulo" name="titulo" value="<%=ter.getTitulo()%>">
        </div>
        <div class="form-group">
            <label class="control-label" for="id_direccion">Direcion</label>
            <input class="form-control" type="text" id="id_direccion" name="direccion" value="<%=ter.getDireccion()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_area">Area</label>
            <input class="form-control" type="text" id="id_area" name="area" value="<%=ter.getArea()%>">
	</div>
        ...
        <div id="inmu3" class="input-group  mb-4">
            ...
            <div class="custom-file border-left-0">
                ...
                <input type="hidden" name="imageDefault" value="<%=ter.getImg()%>">
                <label class="custom-file-label text-muted" for="id_imagen"><%=ter.getImg()%></label>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="id_descripcion">Descripcion</label>
            <input class="form-control" type="text" id="id_descripcion" name="descripcion" value="<%=ter.getDescrip()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_precio">Precio</label>
            <input class="form-control" type="text" id="id_precio" name="precio" value="<%=ter.getPrecio()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_tipo">Tipo</label>
            <input class="form-control" type="text" id="id_tipo" name="tipo" value="<%=ter.getTipo()%>">
	</div>
        <div class="form-group d-none">
            <label class="control-label" for="id_estado">Estado</label>
            <input class="form-control" type="text" id="id_estado" name="estado" value="<%=ter.getEstado()%>">
	</div>
