...
<body>
    <%   
        Departamento dep=(Departamento)request.getAttribute("dato");
    %>
...
<h1>Actualizar Departamento</h1>
    <form action="control" id="id_form" method="post" enctype="multipart/form-data"> 
        <input name="coda" type="hidden" value="<%=dep.getIdInmu()%>">
        <input type="hidden" name="op" value="17">	
        <div class="form-group">
            <label class="control-label" for="id_titulo">Titulo</label>
            <input class="form-control" type="text" id="id_titulo" name="titulo" value="<%=dep.getTitulo()%>">
        </div>
        <div class="form-group">
            <label class="control-label" for="id_direccion">Direcion</label>
            <input class="form-control" type="text" id="id_direccion" name="direccion" value="<%=dep.getDireccion()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_area">Area</label>
            <input class="form-control" type="text" id="id_area" name="area" value="<%=dep.getArea()%>">
	</div>
        ...
        <div id="inmu3" class="input-group  mb-4">
            ...
            <div class="custom-file border-left-0">
                ...
                <input type="hidden" name="imageDefault" value="<%=dep.getImg()%>">
                <label class="custom-file-label text-muted" for="id_imagen"><%=dep.getImg()%></label>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="id_descripcion">Descripcion</label>
            <input class="form-control" type="text" id="id_descripcion" name="descripcion" value="<%=dep.getDescrip()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_precio">Precio</label>
            <input class="form-control" type="text" id="id_precio" name="precio" value="<%=dep.getPrecio()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_tipo">Tipo</label>
            <input class="form-control" type="text" id="id_tipo" name="tipo" value="<%=dep.getTipo()%>">
	</div>
        <div class="form-group d-none">
            <label class="control-label" for="id_estado">Estado</label>
            <input class="form-control" type="text" id="id_estado" name="estado" value="<%=dep.getEstado()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_numhabitaciones">Numero de Habitaciones</label>
            <input class="form-control" type="text" id="id_numhabitaciones" name="numhabitaciones" value="<%=dep.getNumhab()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_numbanos">Numero de Banos</label>
            <input class="form-control" type="text" id="id_numbanos" name="numbanos" value="<%=dep.getNumbanio()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_numestaciona">Numero de Estacionamientos</label>
            <input class="form-control" type="text" id="id_numestaciona" name="numestaciona" value="<%=dep.getNumgarage()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_anioconstruccion">Año de Construccion</label>
            <input class="form-control" type="text" id="id_anioconstruccion" name="anioconstruccion" value="<%=dep.getAniocost()%>">
	</div>
