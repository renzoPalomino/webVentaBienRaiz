...
<body>
    <%   
        Oficina ofi=(Oficina)request.getAttribute("dato");
    %>
...
<h1>Actualizar Oficina</h1>
    <form action="control" id="id_form" method="post" enctype="multipart/form-data"> 
        <input name="coda" type="hidden" value="<%=ofi.getIdInmu()%>">
        <input type="hidden" name="op" value="21">	
        <div class="form-group">
            <label class="control-label" for="id_titulo">Titulo</label>
            <input class="form-control" type="text" id="id_titulo" name="titulo" value="<%=ofi.getTitulo()%>">
        </div>
        <div class="form-group">
            <label class="control-label" for="id_direccion">Direcion</label>
            <input class="form-control" type="text" id="id_direccion" name="direccion" value="<%=ofi.getDireccion()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_area">Area</label>
            <input class="form-control" type="text" id="id_area" name="area" value="<%=ofi.getArea()%>">
	</div>
        ...
        <div id="inmu3" class="input-group  mb-4">
            ...
            <div class="custom-file border-left-0">
                ...
                <input type="hidden" name="imageDefault" value="<%=ofi.getImg()%>">
                <label class="custom-file-label text-muted" for="id_imagen"><%=ofi.getImg()%></label>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label" for="id_descripcion">Descripcion</label>
            <input class="form-control" type="text" id="id_descripcion" name="descripcion" value="<%=ofi.getDescrip()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_precio">Precio</label>
            <input class="form-control" type="text" id="id_precio" name="precio" value="<%=ofi.getPrecio()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_tipo">Tipo</label>
            <input class="form-control" type="text" id="id_tipo" name="tipo" value="<%=ofi.getTipo()%>">
	</div>
        <div class="form-group d-none">
            <label class="control-label" for="id_estado">Estado</label>
            <input class="form-control" type="text" id="id_estado" name="estado" value="<%=ofi.getEstado()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_numbanos">Numero de Banos</label>
            <input class="form-control" type="text" id="id_numbanos" name="numbanos" value="<%=ofi.getNumbanio()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_numestaciona">Numero de Estacionamientos</label>
            <input class="form-control" type="text" id="id_numestaciona" name="numestaciona" value="<%=ofi.getNumgarage()%>">
	</div>
        <div class="form-group">
            <label class="control-label" for="id_anioconstruccion">Año de Construccion</label>
            <input class="form-control" type="text" id="id_anioconstruccion" name="anioconstruccion" value="<%=ofi.getAniocost()%>">
	</div>
